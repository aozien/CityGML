...
public partial class OtherConstructionPropertyType {
    
    private OtherConstructionType otherConstructionField;
    ...
    public OtherConstructionPropertyType() {
        this.ownsField = false;
    }
    
    /// <remarks/>
    public OtherConstructionType OtherConstruction {
        get {
            return this.otherConstructionField;
        }
        set {
            this.otherConstructionField = value;
        }
    }
