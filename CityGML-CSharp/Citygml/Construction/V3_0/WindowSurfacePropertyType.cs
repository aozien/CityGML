...
public partial class WindowSurfacePropertyType {
    
    private WindowSurfaceType windowSurfaceField;
    ...
    public WindowSurfacePropertyType() {
        this.ownsField = false;
    }
    
    /// <remarks/>
    public WindowSurfaceType WindowSurface {
        get {
            return this.windowSurfaceField;
        }
        set {
            this.windowSurfaceField = value;
        }
    }
