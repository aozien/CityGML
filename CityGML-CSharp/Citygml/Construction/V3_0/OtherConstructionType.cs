...
[System.Xml.Serialization.XmlRootAttribute("OtherConstruction", Namespace="http://www.opengis.net/citygml/construction/3.0", IsNullable=false)]
public partial class OtherConstructionType : AbstractTopLevelCityObjectType {
    ...
    private ConstructionSpacePropertyType constructionSpaceField;
    ...
    /// <remarks/>
    public ConstructionSpacePropertyType constructionSpace {
        get {
            return this.constructionSpaceField;
        }
        set {
            this.constructionSpaceField = value;
        }
    }
}
}