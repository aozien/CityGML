...
public partial class DoorSurfacePropertyType {
    
    private DoorSurfaceType doorSurfaceField;
    ...
    public DoorSurfacePropertyType() {
        this.ownsField = false;
    }
    
    /// <remarks/>
    public DoorSurfaceType DoorSurface {
        get {
            return this.doorSurfaceField;
        }
        set {
            this.doorSurfaceField = value;
        }
    }
