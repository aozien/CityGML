...
public partial class GroundSurfacePropertyType {
    
    private GroundSurfaceType groundSurfaceField;
    ...
    public GroundSurfacePropertyType() {
        this.ownsField = false;
    }
    
    /// <remarks/>
    public GroundSurfaceType GroundSurface {
        get {
            return this.groundSurfaceField;
        }
        set {
            this.groundSurfaceField = value;
        }
    }
