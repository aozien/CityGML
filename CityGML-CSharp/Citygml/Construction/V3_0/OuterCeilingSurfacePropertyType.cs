...
public partial class OuterCeilingSurfacePropertyType {
    
    private OuterCeilingSurfaceType outerCeilingSurfaceField;
    ...
    public OuterCeilingSurfacePropertyType() {
        this.ownsField = false;
    }
    
    /// <remarks/>
    public OuterCeilingSurfaceType OuterCeilingSurface {
        get {
            return this.outerCeilingSurfaceField;
        }
        set {
            this.outerCeilingSurfaceField = value;
        }
    }
