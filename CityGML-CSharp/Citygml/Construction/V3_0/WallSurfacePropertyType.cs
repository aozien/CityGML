...
public partial class WallSurfacePropertyType {
    
    private WallSurfaceType wallSurfaceField;
    ...
    public WallSurfacePropertyType() {
        this.ownsField = false;
    }
    
    /// <remarks/>
    public WallSurfaceType WallSurface {
        get {
            return this.wallSurfaceField;
        }
        set {
            this.wallSurfaceField = value;
        }
    }
