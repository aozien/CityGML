...
public partial class AbstractFurniturePropertyType {
    
    private AbstractFurnitureType abstractFurnitureField;
    ...
    public AbstractFurniturePropertyType() {
        this.ownsField = false;
    }
    
    /// <remarks/>
    public AbstractFurnitureType AbstractFurniture {
        get {
            return this.abstractFurnitureField;
        }
        set {
            this.abstractFurnitureField = value;
        }
    }
