...
public partial class AbstractInstallationPropertyType {
    
    private AbstractInstallationType abstractInstallationField;
    ...
    public AbstractInstallationPropertyType() {
        this.ownsField = false;
    }
    
    /// <remarks/>
    public AbstractInstallationType AbstractInstallation {
        get {
            return this.abstractInstallationField;
        }
        set {
            this.abstractInstallationField = value;
        }
    }
