...
public partial class InteriorWallSurfacePropertyType {
    
    private InteriorWallSurfaceType interiorWallSurfaceField;
    ...
    public InteriorWallSurfacePropertyType() {
        this.ownsField = false;
    }
    
    /// <remarks/>
    public InteriorWallSurfaceType InteriorWallSurface {
        get {
            return this.interiorWallSurfaceField;
        }
        set {
            this.interiorWallSurfaceField = value;
        }
    }
