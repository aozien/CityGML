...
public partial class OuterFloorSurfacePropertyType {
    
    private OuterFloorSurfaceType outerFloorSurfaceField;
    ...
    public OuterFloorSurfacePropertyType() {
        this.ownsField = false;
    }
    
    /// <remarks/>
    public OuterFloorSurfaceType OuterFloorSurface {
        get {
            return this.outerFloorSurfaceField;
        }
        set {
            this.outerFloorSurfaceField = value;
        }
    }
