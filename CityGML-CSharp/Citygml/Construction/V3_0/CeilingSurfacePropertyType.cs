...
public partial class CeilingSurfacePropertyType {
    
    private CeilingSurfaceType ceilingSurfaceField;
    ...
    public CeilingSurfacePropertyType() {
        this.ownsField = false;
    }
    
    /// <remarks/>
    public CeilingSurfaceType CeilingSurface {
        get {
            return this.ceilingSurfaceField;
        }
        set {
            this.ceilingSurfaceField = value;
        }
    }
