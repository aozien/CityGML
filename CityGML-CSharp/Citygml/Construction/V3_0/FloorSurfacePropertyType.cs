...
public partial class FloorSurfacePropertyType {
    
    private FloorSurfaceType floorSurfaceField;
    ...
    public FloorSurfacePropertyType() {
        this.ownsField = false;
    }
    
    /// <remarks/>
    public FloorSurfaceType FloorSurface {
        get {
            return this.floorSurfaceField;
        }
        set {
            this.floorSurfaceField = value;
        }
    }
