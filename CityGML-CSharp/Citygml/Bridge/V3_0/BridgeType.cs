...
[System.Xml.Serialization.XmlRootAttribute("Bridge", Namespace="http://www.opengis.net/citygml/bridge/3.0", IsNullable=false)]
public partial class BridgeType : AbstractTopLevelCityObjectType {
    ...
    private BridgeTypeInteriorBridgeRoom[] interiorBridgeRoomField;
    
    private BridgeTypeBridgeInstallation[] bridgeInstallationField;
    
    private BridgeTypeBridgeFurniture[] bridgeFurnitureField;
    
    private BridgeTypeBridgeConstruction[] bridgeConstructionField;
    ...
    private BridgeTypeBridgePart[] bridgePartField;
    ...
    public BridgeTypeInteriorBridgeRoom[] interiorBridgeRoom {
        get {
    ...
    public BridgeTypeBridgeInstallation[] bridgeInstallation {
        get {
    ...
    public BridgeTypeBridgeFurniture[] bridgeFurniture {
        get {
    ...
    public BridgeTypeBridgeConstruction[] bridgeConstruction {
        get {
    ...
    /// <remarks/>
    [System.Xml.Serialization.XmlElementAttribute("bridgePart")]
    public BridgeTypeBridgePart[] bridgePart {
        get {
            return this.bridgePartField;
        }
        set {
            this.bridgePartField = value;
        }
    }
}
}