...
[System.Xml.Serialization.XmlRootAttribute("TexCoordGen", Namespace="http://www.opengis.net/citygml/appearance/3.0", IsNullable=false)]
public partial class TexCoordGenType : AbstractTextureParameterizationType {
    
    private string worldToTextureField;
    ...
    /// <remarks/>
    public string worldToTexture {
        get {
            return this.worldToTextureField;
        }
        set {
            this.worldToTextureField = value;
        }
    }
