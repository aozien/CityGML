...
public partial class ParameterizedTexturePropertyType {
    
    private ParameterizedTextureType parameterizedTextureField;
    ...
    public ParameterizedTexturePropertyType() {
        this.ownsField = false;
    }
    
    /// <remarks/>
    public ParameterizedTextureType ParameterizedTexture {
        get {
            return this.parameterizedTextureField;
        }
        set {
            this.parameterizedTextureField = value;
        }
    }
