...
public partial class X3DMaterialPropertyType {
    
    private X3DMaterialType x3DMaterialField;
    ...
    public X3DMaterialPropertyType() {
        this.ownsField = false;
    }
    
    /// <remarks/>
    public X3DMaterialType X3DMaterial {
        get {
            return this.x3DMaterialField;
        }
        set {
            this.x3DMaterialField = value;
        }
    }
