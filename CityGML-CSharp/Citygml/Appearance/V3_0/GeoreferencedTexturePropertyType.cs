...
public partial class GeoreferencedTexturePropertyType {
    
    private GeoreferencedTextureType georeferencedTextureField;
    ...
    public GeoreferencedTexturePropertyType() {
        this.ownsField = false;
    }
    
    /// <remarks/>
    public GeoreferencedTextureType GeoreferencedTexture {
        get {
            return this.georeferencedTextureField;
        }
        set {
            this.georeferencedTextureField = value;
        }
    }
