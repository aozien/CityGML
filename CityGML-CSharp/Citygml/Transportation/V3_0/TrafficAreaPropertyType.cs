...
public partial class TrafficAreaPropertyType {
    
    private TrafficAreaType trafficAreaField;
    ...
    public TrafficAreaPropertyType() {
        this.ownsField = false;
    }
    
    /// <remarks/>
    public TrafficAreaType TrafficArea {
        get {
            return this.trafficAreaField;
        }
        set {
            this.trafficAreaField = value;
        }
    }
