...
public partial class ManholePropertyType {
    
    private ManholeType manholeField;
    ...
    public ManholePropertyType() {
        this.ownsField = false;
    }
    
    /// <remarks/>
    public ManholeType Manhole {
        get {
            return this.manholeField;
        }
        set {
            this.manholeField = value;
        }
    }
