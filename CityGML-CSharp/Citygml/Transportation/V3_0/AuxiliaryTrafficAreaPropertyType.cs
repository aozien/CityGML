...
public partial class AuxiliaryTrafficAreaPropertyType {
    
    private AuxiliaryTrafficAreaType auxiliaryTrafficAreaField;
    ...
    /// <remarks/>
    public AuxiliaryTrafficAreaType AuxiliaryTrafficArea {
        get {
            return this.auxiliaryTrafficAreaField;
        }
        set {
            this.auxiliaryTrafficAreaField = value;
        }
    }
