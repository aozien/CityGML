...
public partial class RoadwayDamagePropertyType {
    
    private RoadwayDamageType roadwayDamageField;
    ...
    public RoadwayDamagePropertyType() {
        this.ownsField = false;
    }
    
    /// <remarks/>
    public RoadwayDamageType RoadwayDamage {
        get {
            return this.roadwayDamageField;
        }
        set {
            this.roadwayDamageField = value;
        }
    }
