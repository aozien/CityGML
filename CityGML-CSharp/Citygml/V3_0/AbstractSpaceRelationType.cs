...
public abstract partial class AbstractSpaceRelationType : AbstractGMLType {
    
    private AbstractSpacePropertyType spaceRelationField;
    
    /// <remarks/>
    public AbstractSpacePropertyType spaceRelation {
        get {
