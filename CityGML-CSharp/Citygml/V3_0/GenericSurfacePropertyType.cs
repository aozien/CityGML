...
public partial class GenericSurfacePropertyType {
    
    private GenericSurfaceType genericSurfaceField;
    ...
    public GenericSurfacePropertyType() {
        this.ownsField = false;
    }
    
    /// <remarks/>
    public GenericSurfaceType GenericSurface {
        get {
            return this.genericSurfaceField;
        }
        set {
            this.genericSurfaceField = value;
        }
    }
