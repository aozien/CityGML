...
public partial class CityModelPropertyType {
    
    private CityModelType cityModelField;
    ...
    public CityModelPropertyType() {
        this.ownsField = false;
    }
    
    /// <remarks/>
    public CityModelType CityModel {
        get {
            return this.cityModelField;
        }
        set {
            this.cityModelField = value;
        }
    }
