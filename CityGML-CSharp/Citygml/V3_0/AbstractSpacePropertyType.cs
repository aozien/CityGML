...
public partial class AbstractSpacePropertyType {
    
    private AbstractSpaceType abstractSpaceField;
    ...
    public AbstractSpacePropertyType() {
        this.ownsField = false;
    }
    
    /// <remarks/>
    public AbstractSpaceType AbstractSpace {
        get {
            return this.abstractSpaceField;
        }
        set {
            this.abstractSpaceField = value;
        }
    }
