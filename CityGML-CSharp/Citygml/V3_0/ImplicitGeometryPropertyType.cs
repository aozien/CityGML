...
public partial class ImplicitGeometryPropertyType {
    
    private ImplicitGeometryType implicitGeometryField;
    ...
    public ImplicitGeometryPropertyType() {
        this.ownsField = false;
    }
    
    /// <remarks/>
    public ImplicitGeometryType ImplicitGeometry {
        get {
            return this.implicitGeometryField;
        }
        set {
            this.implicitGeometryField = value;
        }
    }
