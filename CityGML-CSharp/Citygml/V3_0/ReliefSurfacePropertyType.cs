...
public partial class ReliefSurfacePropertyType {
    
    private ReliefSurfaceType reliefSurfaceField;
    ...
    public ReliefSurfacePropertyType() {
        this.ownsField = false;
    }
    
    /// <remarks/>
    public ReliefSurfaceType ReliefSurface {
        get {
            return this.reliefSurfaceField;
        }
        set {
            this.reliefSurfaceField = value;
        }
    }
