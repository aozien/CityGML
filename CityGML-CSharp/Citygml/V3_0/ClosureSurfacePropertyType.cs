...
public partial class ClosureSurfacePropertyType {
    
    private ClosureSurfaceType closureSurfaceField;
    ...
    public ClosureSurfacePropertyType() {
        this.ownsField = false;
    }
    
    /// <remarks/>
    public ClosureSurfaceType ClosureSurface {
        get {
            return this.closureSurfaceField;
        }
        set {
            this.closureSurfaceField = value;
        }
    }
