...
public abstract partial class AbstractThematicSurfaceType : AbstractSpaceBoundaryType {
    
    private AbstractThematicSurfaceTypeOpening[] openingField;
    
    private PointCloudPropertyType pointCloudField;
    
    /// <remarks/>
    [System.Xml.Serialization.XmlElementAttribute("opening")]
    public AbstractThematicSurfaceTypeOpening[] opening {
        get {
