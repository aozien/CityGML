...
public partial class BuildingUnitPropertyType {
    
    private BuildingUnitType buildingUnitField;
    ...
    public BuildingUnitPropertyType() {
        this.ownsField = false;
    }
    
    /// <remarks/>
    public BuildingUnitType BuildingUnit {
        get {
