...
[System.Xml.Serialization.XmlRootAttribute("Building", Namespace="http://www.opengis.net/citygml/building/3.0", IsNullable=false)]
public partial class BuildingType : AbstractTopLevelCityObjectType {
    ...
    private BuildingTypeBuildingSubdivision[] buildingSubdivisionField;
    
    private BuildingTypeInteriorRoom[] interiorRoomField;
    
    private BuildingTypeBuildingInstallation[] buildingInstallationField;
    
    private BuildingTypeBuildingFurniture[] buildingFurnitureField;
    
    private BuildingTypeBuildingConstructiveElement[] buildingConstructiveElementField;
    ...
    private BuildingTypeBuildingPart[] buildingPartField;
    ...
    public BuildingTypeBuildingSubdivision[] buildingSubdivision {
        get {
    ...
    public BuildingTypeInteriorRoom[] interiorRoom {
        get {
    ...
    public BuildingTypeBuildingInstallation[] buildingInstallation {
        get {
    ...
    public BuildingTypeBuildingFurniture[] buildingFurniture {
        get {
    ...
    public BuildingTypeBuildingConstructiveElement[] buildingConstructiveElement {
        get {
    ...
    public BuildingTypeBuildingPart[] buildingPart {
        get {
