...
public partial class SensorDescriptionUpdatedTypeValidTime {
    ...
    private AbstractTimeGeometricPrimitiveType abstractTimeGeometricPrimitiveField;
    
    /// <remarks/>
    [System.Xml.Serialization.XmlElementAttribute(Namespace="http://www.opengis.net/gml/3.2")]
    public AbstractTimeGeometricPrimitiveType AbstractTimeGeometricPrimitive {
        get {
            return this.abstractTimeGeometricPrimitiveField;
        }
        set {
            this.abstractTimeGeometricPrimitiveField = value;
        }
    }
}
}