...
public partial class ExtensibleRequestPropertyType {
    ...
    private ExtensibleRequestType extensibleRequestField;
    ...
    /// <remarks/>
    public ExtensibleRequestType ExtensibleRequest {
        get {
            return this.extensibleRequestField;
        }
        set {
            this.extensibleRequestField = value;
        }
    }
