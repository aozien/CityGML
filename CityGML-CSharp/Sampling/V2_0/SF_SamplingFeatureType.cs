...
namespace CityGMLSharp.Sampling.V2_0
{
/// <remarks/>
...
[System.Xml.Serialization.XmlTypeAttribute(Namespace="http://www.opengis.net/sampling/2.0")]
public partial class SF_SamplingFeatureType : AbstractFeatureType {
    
    private ReferenceType typeField;
    
    private FeaturePropertyType sampledFeatureField;
    
    private LI_Lineage_PropertyType lineageField;
    
    private OM_ObservationPropertyType[] relatedObservationField;
    
    private SamplingFeatureComplexPropertyType[] relatedSamplingFeatureField;
    ...
    public FeaturePropertyType sampledFeature {
        get {
            return this.sampledFeatureField;
        }
        set {
            this.sampledFeatureField = value;
        }
    }
    ...
    /// <remarks/>
    [System.Xml.Serialization.XmlElementAttribute("relatedSamplingFeature")]
    public SamplingFeatureComplexPropertyType[] relatedSamplingFeature {
        get {
            return this.relatedSamplingFeatureField;
        }
        set {
            this.relatedSamplingFeatureField = value;
        }
    }
