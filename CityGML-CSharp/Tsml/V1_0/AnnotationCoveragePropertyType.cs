...
public partial class AnnotationCoveragePropertyType {
    
    private AnnotationCoverageType annotationCoverageField;
    ...
    public AnnotationCoveragePropertyType() {
        this.ownsField = false;
    }
    
    /// <remarks/>
    public AnnotationCoverageType AnnotationCoverage {
        get {
            return this.annotationCoverageField;
        }
        set {
            this.annotationCoverageField = value;
        }
    }
