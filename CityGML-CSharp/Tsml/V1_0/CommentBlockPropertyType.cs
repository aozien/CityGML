...
public partial class CommentBlockPropertyType {
    
    private CommentBlockType commentBlockField;
    
    private bool ownsField;
    
    public CommentBlockPropertyType() {
        this.ownsField = false;
    }
    
    /// <remarks/>
    public CommentBlockType CommentBlock {
        get {
