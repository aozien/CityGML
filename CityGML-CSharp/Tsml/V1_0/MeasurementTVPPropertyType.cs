...
public partial class MeasurementTVPPropertyType {
    
    private MeasurementTVPType measurementTVPField;
    ...
    public MeasurementTVPPropertyType() {
        this.ownsField = false;
    }
    
    /// <remarks/>
    public MeasurementTVPType MeasurementTVP {
        get {
            return this.measurementTVPField;
        }
        set {
            this.measurementTVPField = value;
        }
    }
