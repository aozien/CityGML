...
public partial class TimeseriesTVPPropertyType {
    
    private TimeseriesTVPType timeseriesTVPField;
    ...
    public TimeseriesTVPPropertyType() {
        this.ownsField = false;
    }
    
    /// <remarks/>
    public TimeseriesTVPType TimeseriesTVP {
        get {
            return this.timeseriesTVPField;
        }
        set {
            this.timeseriesTVPField = value;
        }
    }
