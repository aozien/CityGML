...
public partial class ObservationProcessPropertyType {
    
    private ObservationProcessType observationProcessField;
    ...
    public ObservationProcessPropertyType() {
        this.ownsField = false;
    }
    
    /// <remarks/>
    public ObservationProcessType ObservationProcess {
        get {
            return this.observationProcessField;
        }
        set {
            this.observationProcessField = value;
        }
    }
