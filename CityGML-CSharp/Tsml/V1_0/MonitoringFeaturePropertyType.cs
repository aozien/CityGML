...
public partial class MonitoringFeaturePropertyType {
    
    private MonitoringFeatureType monitoringFeatureField;
    ...
    public MonitoringFeaturePropertyType() {
        this.ownsField = false;
    }
    
    /// <remarks/>
    public MonitoringFeatureType MonitoringFeature {
        get {
            return this.monitoringFeatureField;
        }
        set {
            this.monitoringFeatureField = value;
        }
    }
