...
public partial class CategoricalTVPPropertyType {
    
    private CategoricalTVPType categoricalTVPField;
    ...
    public CategoricalTVPPropertyType() {
        this.ownsField = false;
    }
    
    /// <remarks/>
    public CategoricalTVPType CategoricalTVP {
        get {
            return this.categoricalTVPField;
        }
        set {
            this.categoricalTVPField = value;
        }
    }
