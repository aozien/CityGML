...
public abstract partial class AbstractGeneralDerivedCRSType1 : AbstractCRSType {
    
    private GeneralConversionPropertyType1 conversionField;
    
    /// <remarks/>
    public GeneralConversionPropertyType1 conversion {
        get {
