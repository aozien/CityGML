...
[System.Xml.Serialization.XmlTypeAttribute(TypeName="DirectedEdgePropertyType", Namespace="http://www.opengis.net/gml/3.2")]
[System.Xml.Serialization.XmlRootAttribute("directedEdge", Namespace="http://www.opengis.net/gml/3.2", IsNullable=false)]
public partial class DirectedEdgePropertyType1 {
    
    private EdgeType1 edgeField;
    ...
    public DirectedEdgePropertyType1() {
        this.orientationField = SignType.Item1;
        this.ownsField = false;
    }
    
    /// <remarks/>
    public EdgeType1 Edge {
        get {
