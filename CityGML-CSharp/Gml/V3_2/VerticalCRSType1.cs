...
[System.Xml.Serialization.XmlTypeAttribute(TypeName="VerticalCRSType", Namespace="http://www.opengis.net/gml/3.2")]
[System.Xml.Serialization.XmlRootAttribute("VerticalCRS", Namespace="http://www.opengis.net/gml/3.2", IsNullable=false)]
public partial class VerticalCRSType1 : AbstractCRSType {
    
    private VerticalCSPropertyType1 verticalCSField;
    
    private VerticalDatumPropertyType1 verticalDatumField;
    
    /// <remarks/>
    public VerticalCSPropertyType1 verticalCS {
        get {
