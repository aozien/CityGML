...
[System.Xml.Serialization.XmlTypeAttribute(TypeName="FaceType", Namespace="http://www.opengis.net/gml/3.2")]
[System.Xml.Serialization.XmlRootAttribute("Face", Namespace="http://www.opengis.net/gml/3.2", IsNullable=false)]
public partial class FaceType1 : AbstractTopoPrimitiveType1 {
    
    private NodePropertyType[] isolatedField;
    
    private DirectedEdgePropertyType1[] directedEdgeField;
    
    private DirectedTopoSolidPropertyType1[] directedTopoSolidField;
    ...
    public DirectedEdgePropertyType1[] directedEdge {
        get {
    ...
    public DirectedTopoSolidPropertyType1[] directedTopoSolid {
        get {
