...
[System.Xml.Serialization.XmlTypeAttribute(TypeName="DerivedCRSType", Namespace="http://www.opengis.net/gml/3.2")]
[System.Xml.Serialization.XmlRootAttribute("DerivedCRS", Namespace="http://www.opengis.net/gml/3.2", IsNullable=false)]
public partial class DerivedCRSType1 : AbstractGeneralDerivedCRSType1 {
    
    private SingleCRSPropertyType1 baseCRSField;
    
    private CodeWithAuthorityType derivedCRSTypeField;
    
    private CoordinateSystemPropertyType1 coordinateSystemField;
    
    /// <remarks/>
    public SingleCRSPropertyType1 baseCRS {
        get {
    ...
    /// <remarks/>
    public CoordinateSystemPropertyType1 coordinateSystem {
        get {
