...
[System.Xml.Serialization.XmlTypeAttribute(TypeName="AbstractFeatureCollectionType", Namespace="http://www.opengis.net/gml/3.2")]
public abstract partial class AbstractFeatureCollectionType1 : AbstractFeatureType {
    
    private FeaturePropertyType[] featureMemberField;
    
    private FeatureArrayPropertyType1 featureMembersField;
    ...
    /// <remarks/>
    public FeatureArrayPropertyType1 featureMembers {
        get {
