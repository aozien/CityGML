...
[System.Xml.Serialization.XmlTypeAttribute(TypeName="EdgeType", Namespace="http://www.opengis.net/gml/3.2")]
[System.Xml.Serialization.XmlRootAttribute("Edge", Namespace="http://www.opengis.net/gml/3.2", IsNullable=false)]
public partial class EdgeType1 : AbstractTopoPrimitiveType1 {
    
    private TopoSolidPropertyType containerField;
    
    private DirectedNodePropertyType1[] directedNodeField;
    
    private DirectedFacePropertyType1[] directedFaceField;
    ...
    public DirectedNodePropertyType1[] directedNode {
        get {
    ...
    public DirectedFacePropertyType1[] directedFace {
        get {
