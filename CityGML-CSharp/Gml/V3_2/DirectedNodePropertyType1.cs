...
[System.Xml.Serialization.XmlTypeAttribute(TypeName="DirectedNodePropertyType", Namespace="http://www.opengis.net/gml/3.2")]
[System.Xml.Serialization.XmlRootAttribute("directedNode", Namespace="http://www.opengis.net/gml/3.2", IsNullable=false)]
public partial class DirectedNodePropertyType1 {
    
    private NodeType1 nodeField;
    ...
    public DirectedNodePropertyType1() {
        this.orientationField = SignType.Item1;
        this.ownsField = false;
    }
    
    /// <remarks/>
    public NodeType1 Node {
        get {
