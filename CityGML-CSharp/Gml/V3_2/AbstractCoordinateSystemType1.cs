...
public abstract partial class AbstractCoordinateSystemType1 : IdentifiedObjectType {
    
    private CoordinateSystemAxisPropertyType1[] axisField;
    ...
    public CoordinateSystemAxisPropertyType1[] axis {
        get {
