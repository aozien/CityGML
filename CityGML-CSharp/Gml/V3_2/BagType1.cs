...
public partial class BagType1 : AbstractGMLType {
    ...
    private AssociationRoleType1[] memberField;
    
    private ArrayAssociationType1 membersField;
    
    /// <remarks/>
    [System.Xml.Serialization.XmlElementAttribute("member")]
    public AssociationRoleType1[] member {
        get {
    ...
    /// <remarks/>
    public ArrayAssociationType1 members {
        get {
