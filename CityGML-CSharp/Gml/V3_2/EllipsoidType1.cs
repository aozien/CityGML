...
[System.Xml.Serialization.XmlTypeAttribute(TypeName="EllipsoidType", Namespace="http://www.opengis.net/gml/3.2")]
[System.Xml.Serialization.XmlRootAttribute("Ellipsoid", Namespace="http://www.opengis.net/gml/3.2", IsNullable=false)]
public partial class EllipsoidType1 : IdentifiedObjectType {
    
    private MeasureType semiMajorAxisField;
    
    private SecondDefiningParameter1 secondDefiningParameterField;
    ...
    /// <remarks/>
    public SecondDefiningParameter1 secondDefiningParameter {
        get {
