...
[System.Xml.Serialization.XmlTypeAttribute(TypeName="EnvelopeWithTimePeriodType", Namespace="http://www.opengis.net/gml")]
[System.Xml.Serialization.XmlRootAttribute("EnvelopeWithTimePeriod", Namespace="http://www.opengis.net/gml", IsNullable=false)]
public partial class EnvelopeWithTimePeriodType1 : EnvelopeType1 {
    
    private TimePositionType1 beginPositionField;
    
    private TimePositionType1 endPositionField;
    
    private string frameField;
    
    public EnvelopeWithTimePeriodType1() {
        this.frameField = "#ISO-8601";
    }
    
    /// <remarks/>
    public TimePositionType1 beginPosition {
        get {
    ...
    /// <remarks/>
    public TimePositionType1 endPosition {
        get {
