...
public abstract partial class AbstractFeatureCollectionType : AbstractFeatureType1 {
    
    private FeaturePropertyType1[] featureMemberField;
    
    private FeatureArrayPropertyType featureMembersField;
    
    /// <remarks/>
    [System.Xml.Serialization.XmlElementAttribute("featureMember")]
    public FeaturePropertyType1[] featureMember {
        get {
