...
[System.Xml.Serialization.XmlTypeAttribute(TypeName="PolygonPatchType", Namespace="http://www.opengis.net/gml")]
[System.Xml.Serialization.XmlRootAttribute("PolygonPatch", Namespace="http://www.opengis.net/gml", IsNullable=false)]
public partial class PolygonPatchType1 : AbstractSurfacePatchType1 {
    
    private AbstractRingPropertyType1 exteriorField;
    
    private AbstractRingPropertyType1[] interiorField;
    
    private SurfaceInterpolationType1 interpolationField;
    ...
    /// <remarks/>
    public AbstractRingPropertyType1 exterior {
        get {
    ...
    public AbstractRingPropertyType1[] interior {
        get {
    ...
    public SurfaceInterpolationType1 interpolation {
        get {
