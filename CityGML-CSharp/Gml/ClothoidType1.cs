...
[System.Xml.Serialization.XmlTypeAttribute(TypeName="ClothoidType", Namespace="http://www.opengis.net/gml")]
[System.Xml.Serialization.XmlRootAttribute("Clothoid", Namespace="http://www.opengis.net/gml", IsNullable=false)]
public partial class ClothoidType1 : AbstractCurveSegmentType1 {
    
    private ClothoidTypeRefLocation1 refLocationField;
    ...
    public ClothoidType1() {
        this.interpolationField = CurveInterpolationType1.clothoid;
    }
    
    /// <remarks/>
    public ClothoidTypeRefLocation1 refLocation {
        get {
