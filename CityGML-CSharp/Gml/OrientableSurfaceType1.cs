...
[System.Xml.Serialization.XmlTypeAttribute(TypeName="OrientableSurfaceType", Namespace="http://www.opengis.net/gml")]
[System.Xml.Serialization.XmlRootAttribute("OrientableSurface", Namespace="http://www.opengis.net/gml", IsNullable=false)]
public partial class OrientableSurfaceType1 : AbstractSurfaceType1 {
    
    private SurfacePropertyType1 baseSurfaceField;
    
    private SignType1 orientationField;
    
    public OrientableSurfaceType1() {
        this.orientationField = SignType1.Item1;
    }
    
    /// <remarks/>
    public SurfacePropertyType1 baseSurface {
        get {
