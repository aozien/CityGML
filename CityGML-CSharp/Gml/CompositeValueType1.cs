...
[System.Xml.Serialization.XmlTypeAttribute(TypeName="CompositeValueType", Namespace="http://www.opengis.net/gml")]
[System.Xml.Serialization.XmlRootAttribute("CompositeValue", Namespace="http://www.opengis.net/gml", IsNullable=false)]
public partial class CompositeValueType1 : AbstractGMLType1 {
    
    private ValuePropertyType1[] valueComponentField;
    
    private ValueArrayPropertyType1 valueComponentsField;
    ...
    public ValuePropertyType1[] valueComponent {
        get {
    ...
    /// <remarks/>
    public ValueArrayPropertyType1 valueComponents {
        get {
