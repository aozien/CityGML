...
[System.Xml.Serialization.XmlTypeAttribute(TypeName="DomainSetType", Namespace="http://www.opengis.net/gml")]
[System.Xml.Serialization.XmlRootAttribute("domainSet", Namespace="http://www.opengis.net/gml", IsNullable=false)]
public partial class DomainSetType1 {
    
    private AbstractGMLType1 itemField;
    ...
    public DomainSetType1() {
        this.ownsField = false;
    }
    
    /// <remarks/>
    [System.Xml.Serialization.XmlElementAttribute("AbstractGeometry", typeof(AbstractGeometryType1))]
    [System.Xml.Serialization.XmlElementAttribute("AbstractTimeObject", typeof(AbstractTimeObjectType1))]
    public AbstractGMLType1 Item {
        get {
