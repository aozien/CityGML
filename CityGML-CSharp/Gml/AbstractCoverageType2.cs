...
[System.Xml.Serialization.XmlTypeAttribute(TypeName="AbstractCoverageType", Namespace="http://www.opengis.net/gml")]
public abstract partial class AbstractCoverageType2 : AbstractFeatureType1 {
    
    private DomainSetType1 domainSetField;
    
    private RangeSetType1 rangeSetField;
    
    /// <remarks/>
    public DomainSetType1 domainSet {
        get {
