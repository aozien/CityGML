...
public partial class OperationMethodType : IdentifiedObjectType1 {
    
    private CodeType1 formulaField;
    
    private string sourceDimensionsField;
    
    private string targetDimensionsField;
    
    private AbstractGeneralOperationParameterPropertyType[] generalOperationParameterField;
    
    /// <remarks/>
    public CodeType1 formula {
        get {
    ...
    public AbstractGeneralOperationParameterPropertyType[] generalOperationParameter {
        get {
            return this.generalOperationParameterField;
        }
        set {
            this.generalOperationParameterField = value;
        }
    }
}
}