...
[System.Xml.Serialization.XmlTypeAttribute(TypeName="OrientableCurveType", Namespace="http://www.opengis.net/gml")]
[System.Xml.Serialization.XmlRootAttribute("OrientableCurve", Namespace="http://www.opengis.net/gml", IsNullable=false)]
public partial class OrientableCurveType1 : AbstractCurveType1 {
    
    private CurvePropertyType1 baseCurveField;
    
    private SignType1 orientationField;
    
    public OrientableCurveType1() {
        this.orientationField = SignType1.Item1;
    }
    
    /// <remarks/>
    public CurvePropertyType1 baseCurve {
        get {
