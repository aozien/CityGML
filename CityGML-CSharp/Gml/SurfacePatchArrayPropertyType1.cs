...
[System.Xml.Serialization.XmlTypeAttribute(TypeName="SurfacePatchArrayPropertyType", Namespace="http://www.opengis.net/gml")]
[System.Xml.Serialization.XmlRootAttribute("patches", Namespace="http://www.opengis.net/gml", IsNullable=false)]
public partial class SurfacePatchArrayPropertyType1 {
    
    private AbstractSurfacePatchType1[] abstractSurfacePatchField;
    
    /// <remarks/>
    [System.Xml.Serialization.XmlElementAttribute("AbstractSurfacePatch")]
    public AbstractSurfacePatchType1[] AbstractSurfacePatch {
        get {
